...
export default function Hero() {
  ...
  return (
    <section id="inicio" className="bg-white w-full pt-20 md:pt-24">
      ...
      {/* ✅ Versión ESCRITORIO / TABLET (diseño actual) */}
      <div className="hidden md:flex max-w-screen-xl mx-auto flex-col-reverse md:flex-row items-center gap-10 px-6 pt-24 pb-4">
        ...
        <div className="w-full md:w-1/2 text-center md:text-left space-y-6">
          ...
          <div className="flex flex-wrap justify-center md:justify-start gap-3 sm:gap-4">
            <button
              onClick={() => navigate("/agenda")}
              className="flex items-center justify-center gap-2 bg-purple-700 text-white px-5 py-3 rounded-lg font-medium hover:bg-purple-800 transition w-full sm:w-auto"
            >
              <FontAwesomeIcon icon={faCalendarDays} />
              Agenda tu cita
            </button>
          ...
          {/* Promo */}
          <div className="mt-8 border-4 border-purple-700 rounded-lg shadow-xl p-5 bg-white w-full sm:w-80 xl:w-96">
            <p className="text-lg font-semibold text-gray-800">PROMO ESPECIAL</p>
            <h3 className="text-xl font-extrabold text-purple-700">COLPOSCOPIA + CONSULTA</h3>
            <p className="text-5xl font-black text-purple-800 mt-2">
              <span className="text-3xl align-top text-gray-700">$</span>450
